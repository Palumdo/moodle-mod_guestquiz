...
$string['guestquiz:respond']                  = 'Respond to Questionnaire';
...
$string['guestquiznotsupported']              = 'Question type not supported';
$string['guestquizwaswrong']                  = 'was a wrong answer';
$string['guestquizwasright']                  = 'was a right answer';
$string['guestquizbadformat']                 = 'There is a format problem';
