...
/**
 * Extends the settings navigation with the guestquiz settings.
 *
 * This function is called when the context for the page is a guestquiz module.
 * This is not called by AJAX so it is safe to rely on the $PAGE.
 *
 * @param object $settings
 * @param object $navref
 */
function guestquiz_extend_settings_navigation(settings_navigation $settings, navigation_node $navref) {
    global $PAGE;
    ...
    if (has_capability('mod/guestquiz:create', $context)) {
    }
}
